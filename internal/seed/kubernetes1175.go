...
var kubernetes1175ReleaseSpecs = []kubernetes1175ReleaseSpec{
	...
	{componentID: "component-host-bootstrap", slug: "host-bootstrap", variant: "worker", name: "Host Bootstrap", description: "配置 Kubernetes 主机所需用户、目录和基础系统参数。", releaseID: "release-host-bootstrap-k8s-1.17.5-worker", version: "v1.17.5-r1-worker", action: domain.ActionConfigure, hostGroup: "k8snode", dependencies: []kubernetes1175DependencySpec{{"component-host-preflight", "release-host-preflight-k8s-1.17.5", "host and topology preflight"}}},
	...
	{componentID: "component-docker", slug: "docker", variant: "worker", name: "Docker", description: "Kubernetes 1.17.5 使用的 Docker CRI 运行时。", releaseID: "release-docker-18.09.7-worker", version: "18.09.7-worker", action: domain.ActionInstall, hostGroup: "k8snode", dependencies: []kubernetes1175DependencySpec{{"component-host-bootstrap", "release-host-bootstrap-k8s-1.17.5-worker", "prepared worker hosts"}}},
	...
	{componentID: "component-kubernetes-distribution", slug: "kubernetes-distribution", variant: "worker", name: "Kubernetes Distribution", description: "只安装 Kubernetes 1.17.5 公共二进制和静态文件。", releaseID: "release-kubernetes-distribution-1.17.5-worker", version: "1.17.5-worker", action: domain.ActionInstall, hostGroup: "k8snode", dependencies: []kubernetes1175DependencySpec{{"component-cluster-pki", "release-cluster-pki-k8s-1.17.5", "cluster trust material"}}},
	...
	{componentID: "component-flannel", slug: "flannel", variant: "worker", name: "Flannel", description: "Kubernetes 1.17.5 集群 Pod 网络。", releaseID: "release-flannel-0.11.0-worker", version: "0.11.0-worker", action: domain.ActionInstall, hostGroup: "k8snode", dependencies: []kubernetes1175DependencySpec{{"component-docker", "release-docker-18.09.7-worker", "container runtime"}, {"component-etcd", "release-etcd-3.3.10", "network state"}, {"component-cluster-pki", "release-cluster-pki-k8s-1.17.5", "etcd client certificate"}}},
	...
	{componentID: "component-kubelet", slug: "kubelet", variant: "worker", name: "kubelet", description: "独立安装并启动 Kubernetes 节点代理。", releaseID: "release-kubelet-1.17.5-worker", version: "1.17.5-worker", action: domain.ActionInstall, hostGroup: "k8snode", dependencies: []kubernetes1175DependencySpec{{"component-docker", "release-docker-18.09.7-worker", "container runtime"}, {"component-kubernetes-distribution", "release-kubernetes-distribution-1.17.5-worker", "node binaries"}, {"component-flannel", "release-flannel-0.11.0-worker", "pod network"}, {"component-kube-apiserver", "release-kube-apiserver-1.17.5", "available API server"}, {"component-kubernetes-bootstrap-rbac", "release-kubernetes-bootstrap-rbac-1.17.5", "TLS bootstrap authorization"}}},
	...
	{componentID: "component-kube-proxy", slug: "kube-proxy", variant: "worker", name: "kube-proxy", description: "Kubernetes 1.17.5 节点 Service 网络代理 Release。", releaseID: "release-kube-proxy-1.17.5-worker", version: "1.17.5-worker", action: domain.ActionInstall, hostGroup: "k8snode", dependencies: []kubernetes1175DependencySpec{{"component-kubelet", "release-kubelet-1.17.5-worker", "running node service"}, {"component-kubernetes-distribution", "release-kubernetes-distribution-1.17.5-worker", "node binaries"}, {"component-cluster-pki", "release-cluster-pki-k8s-1.17.5", "proxy credentials"}}},
	...
	{componentID: "component-node-logging", slug: "node-logging", variant: "worker", name: "Node Logging", description: "配置节点日志目录和轮转策略。", releaseID: "release-node-logging-k8s-1.17.5-worker", version: "v1.17.5-r1-worker", action: domain.ActionConfigure, hostGroup: "k8snode", dependencies: []kubernetes1175DependencySpec{{"component-host-bootstrap", "release-host-bootstrap-k8s-1.17.5-worker", "prepared worker hosts"}}},
	...
	{componentID: "component-blackbox-exporter", slug: "blackbox-exporter", variant: "etcd", name: "Blackbox Exporter", description: "源快照中的探测 Exporter，未确认上游软件版本。", releaseID: "release-blackbox-exporter-source-6909da3-etcd", version: "source-6909da3-etcd", action: domain.ActionInstall, hostGroup: "k8setcd", dependencies: []kubernetes1175DependencySpec{{"component-host-bootstrap", "release-host-bootstrap-k8s-1.17.5", "prepared control-plane hosts"}}},
	{componentID: "component-blackbox-exporter", slug: "blackbox-exporter", variant: "worker", name: "Blackbox Exporter", description: "源快照中的探测 Exporter，未确认上游软件版本。", releaseID: "release-blackbox-exporter-source-6909da3-worker", version: "source-6909da3-worker", action: domain.ActionInstall, hostGroup: "k8snode", dependencies: []kubernetes1175DependencySpec{{"component-host-bootstrap", "release-host-bootstrap-k8s-1.17.5-worker", "prepared worker hosts"}}},
	...
	{componentID: "component-node-exporter", slug: "node-exporter", variant: "worker", name: "Node Exporter", description: "节点操作系统指标 Exporter。", releaseID: "release-node-exporter-0.18.0-worker", version: "0.18.0-worker", action: domain.ActionInstall, hostGroup: "k8snode", dependencies: []kubernetes1175DependencySpec{{"component-host-bootstrap", "release-host-bootstrap-k8s-1.17.5-worker", "prepared worker hosts"}}},
	...
	{componentID: "component-amc", slug: "amc", variant: "worker", name: "AMC", description: "源快照中的 AMC 节点能力，未确认软件版本。", releaseID: "release-amc-source-6909da3-worker", version: "source-6909da3-worker", action: domain.ActionInstall, hostGroup: "k8snode", dependencies: []kubernetes1175DependencySpec{{"component-kubelet", "release-kubelet-1.17.5-worker", "running worker nodes"}}},
	...
	{componentID: "component-glusterfs-client", slug: "glusterfs-client", variant: "worker", name: "GlusterFS Client", description: "节点 GlusterFS 客户端。", releaseID: "release-glusterfs-client-3.12.6-worker", version: "3.12.6-worker", action: domain.ActionInstall, hostGroup: "k8snode", dependencies: []kubernetes1175DependencySpec{{"component-host-bootstrap", "release-host-bootstrap-k8s-1.17.5-worker", "prepared worker hosts"}}},
	...
	{componentID: "component-go-pprof-toolkit", slug: "go-pprof-toolkit", variant: "etcd", name: "Go/pprof Toolkit", description: "源快照中的 Go 与 pprof 运维工具，未确认软件版本。", releaseID: "release-go-pprof-toolkit-source-6909da3-etcd", version: "source-6909da3-etcd", action: domain.ActionInstall, hostGroup: "k8setcd", dependencies: []kubernetes1175DependencySpec{{"component-host-bootstrap", "release-host-bootstrap-k8s-1.17.5", "prepared control-plane hosts"}}},
	{componentID: "component-go-pprof-toolkit", slug: "go-pprof-toolkit", variant: "worker", name: "Go/pprof Toolkit", description: "源快照中的 Go 与 pprof 运维工具，未确认软件版本。", releaseID: "release-go-pprof-toolkit-source-6909da3-worker", version: "source-6909da3-worker", action: domain.ActionInstall, hostGroup: "k8snode", dependencies: []kubernetes1175DependencySpec{{"component-host-bootstrap", "release-host-bootstrap-k8s-1.17.5-worker", "prepared worker hosts"}}},
...
func kubernetes1175Parameters() []domain.ParameterDefinition {
	return []domain.ParameterDefinition{
		{Name: "K8S_VERSION", Description: "Kubernetes 发行版本", Type: domain.ParameterTypeString, Required: true, FixedValue: "v1.17.5", Visibility: domain.ParameterInternal, ValueProvider: domain.ParameterProviderComponentOwner, Enum: []any{"v1.17.5"}},
		{Name: "K8S1175_ARTIFACTS_VERIFIED", Description: "核心制品是否已验真", Type: domain.ParameterTypeBoolean, Required: true, FixedValue: false, Visibility: domain.ParameterInternal, ValueProvider: domain.ParameterProviderComponentOwner},
		{Name: "K8S1175_OPTIONAL_ARTIFACTS_VERIFIED", Description: "可选制品是否已验真", Type: domain.ParameterTypeBoolean, Required: true, FixedValue: false, Visibility: domain.ParameterInternal, ValueProvider: domain.ParameterProviderComponentOwner},
		{Name: "K8S1175_DOCKER_RUNTIME_VERIFIED", Description: "Docker 运行时是否已验真", Type: domain.ParameterTypeBoolean, Required: true, FixedValue: false, Visibility: domain.ParameterInternal, ValueProvider: domain.ParameterProviderComponentOwner},
		{Name: "K8S1175_DOCKER_VERSION", Description: "Docker 版本", Type: domain.ParameterTypeString, Required: true, FixedValue: "18.09.7", Visibility: domain.ParameterInternal, ValueProvider: domain.ParameterProviderComponentOwner, Enum: []any{"18.09.7"}},
		{Name: "IHS_IP", Description: "制品仓库地址", Type: domain.ParameterTypeString, Required: true, FixedValue: "192.0.2.80", Visibility: domain.ParameterInternal, ValueProvider: domain.ParameterProviderComponentOwner},
		{Name: "IHS_PORT", Description: "制品仓库端口", Type: domain.ParameterTypeInteger, Required: true, FixedValue: 8080, Visibility: domain.ParameterInternal, ValueProvider: domain.ParameterProviderComponentOwner},
		{Name: "ENABLE_VM_CHECK", Description: "是否启用虚机检查", Type: domain.ParameterTypeBoolean, Required: true, FixedValue: false, Visibility: domain.ParameterInternal, ValueProvider: domain.ParameterProviderComponentOwner},
	}
}
...
func kubernetes1175ReleaseParameters(componentID string) []domain.ParameterDefinition {
	...
	case "component-kubelet":
		parameters = append(parameters, domain.ParameterDefinition{
			...
			Required: true, FixedValue: "/approot1/paas/kube", Visibility: domain.ParameterPublic, ValueProvider: domain.ParameterProviderComponentOwner,
			MinLength: 1,
		})
	case "component-kube-proxy":
		parameters = append(parameters, domain.ParameterDefinition{
			Name: "kubeRoot", Description: "复用 kubelet 安装目录", Type: domain.ParameterTypeString,
			Required: true, Visibility: domain.ParameterInternal, ValueProvider: domain.ParameterProviderUpstreamMapping, TestValue: "/approot1/paas/kube", MinLength: 1,
		})
	}
	return parameters
}
...
func (s Seeder) seedKubernetes1175Catalog(ctx context.Context, now time.Time) error {
	...
	for _, spec := range kubernetes1175ReleaseSpecs {
		...
		contractKey := spec.slug
		if spec.variant != "" {
			contractKey += "-" + spec.variant
		}
		actions := []domain.ActionDefinition{{
			ID: "action-" + contractKey + "-" + string(spec.action), ReleaseID: spec.releaseID,
			Name: string(spec.action) + " " + spec.name, Kind: spec.action,
			Playbook:  "k8s-1.17.5-cluster/components/" + spec.slug + ".yml",
			HostGroup: spec.hostGroup, TimeoutSeconds: 3600,
		...
		release := domain.ComponentRelease{
			...
			Status: domain.ReleaseReleased, ReleaseNotes: "来自 6909da3 作业快照的最小逻辑组件；本发布线固定目标主机组 " + spec.hostGroup + "，介质未完成部署验真。",
...
func kubernetes1175Node(id, name, releaseID string, x, y float64) domain.ScenarioNode {
	action, hostGroup := domain.ActionInstall, ""
	for _, spec := range kubernetes1175ReleaseSpecs {
		if spec.releaseID == releaseID {
			action, hostGroup = spec.action, spec.hostGroup
			break
		}
	}
	node := domain.ScenarioNode{ID: id, Name: name, ReleaseID: releaseID, Action: action, HostGroup: hostGroup, ParameterValues: map[string]any{}, Position: domain.GraphPosition{X: x, Y: y}, Destructive: action != domain.ActionPreflight}
	switch id {
	...
	case "k8s1175-proxy-worker":
		node.DependencySources = map[string]string{"dependency-kube-proxy-worker-1": "k8s1175-kubelet-worker"}
	...
	case "k8s1175-ext-proxy-worker":
		node.DependencySources = map[string]string{"dependency-kube-proxy-worker-1": "k8s1175-ext-kubelet-worker"}
	}
	return node
}
...
func kubernetes1175CoreGraph(prefix string) domain.ScenarioGraph {
	nodes := []domain.ScenarioNode{
		kubernetes1175Node(prefix+"preflight", "Host Preflight", "release-host-preflight-k8s-1.17.5", 40, 300),
		kubernetes1175Node(prefix+"bootstrap-master", "Host Bootstrap · Control", "release-host-bootstrap-k8s-1.17.5", 300, 180),
		kubernetes1175Node(prefix+"bootstrap-worker", "Host Bootstrap · Worker", "release-host-bootstrap-k8s-1.17.5-worker", 300, 420),
		kubernetes1175Node(prefix+"pki", "Cluster PKI", "release-cluster-pki-k8s-1.17.5", 560, 60),
		kubernetes1175Node(prefix+"docker-master", "Docker · Control", "release-docker-18.09.7", 560, 180),
		kubernetes1175Node(prefix+"docker-worker", "Docker · Worker", "release-docker-18.09.7-worker", 560, 540),
		kubernetes1175Node(prefix+"distribution-master", "Distribution · Control", "release-kubernetes-distribution-1.17.5", 820, 120),
		kubernetes1175Node(prefix+"distribution-worker", "Distribution · Worker", "release-kubernetes-distribution-1.17.5-worker", 820, 480),
		kubernetes1175Node(prefix+"etcd", "etcd", "release-etcd-3.3.10", 820, 0),
		kubernetes1175Node(prefix+"encryption", "Encryption Configuration", "release-kubernetes-encryption-config-1.17.5", 1080, 60),
		kubernetes1175Node(prefix+"apiserver", "kube-apiserver", "release-kube-apiserver-1.17.5", 1340, 60),
		kubernetes1175Node(prefix+"controller", "kube-controller-manager", "release-kube-controller-manager-1.17.5", 1600, 0),
		kubernetes1175Node(prefix+"scheduler", "kube-scheduler", "release-kube-scheduler-1.17.5", 1600, 100),
		kubernetes1175Node(prefix+"rbac", "Bootstrap RBAC", "release-kubernetes-bootstrap-rbac-1.17.5", 1600, 200),
		kubernetes1175Node(prefix+"flannel-master", "Flannel · Control", "release-flannel-0.11.0", 1080, 300),
		kubernetes1175Node(prefix+"flannel-worker", "Flannel · Worker", "release-flannel-0.11.0-worker", 1080, 540),
		kubernetes1175Node(prefix+"kubelet-master", "kubelet · Control", "release-kubelet-1.17.5", 1860, 300),
		kubernetes1175Node(prefix+"kubelet-worker", "kubelet · Worker", "release-kubelet-1.17.5-worker", 1860, 540),
		kubernetes1175Node(prefix+"proxy-master", "kube-proxy · Control", "release-kube-proxy-1.17.5", 2120, 300),
		kubernetes1175Node(prefix+"proxy-worker", "kube-proxy · Worker", "release-kube-proxy-1.17.5-worker", 2120, 540),
		kubernetes1175Node(prefix+"coredns", "CoreDNS", "release-coredns-1.3.1", 2380, 180),
	}
	edgePairs := [][2]string{
...
func (s Seeder) seedKubernetes1175Scenarios(ctx context.Context, now time.Time) error {
	...
	optionalNodes := []domain.ScenarioNode{
		kubernetes1175Node("k8s1175-ext-logging-master", "Node Logging · Control", "release-node-logging-k8s-1.17.5", 2640, 0),
		kubernetes1175Node("k8s1175-ext-logging-worker", "Node Logging · Worker", "release-node-logging-k8s-1.17.5-worker", 2640, 100),
		kubernetes1175Node("k8s1175-ext-haproxy", "HAProxy", "release-haproxy-source-6909da3", 2640, 200),
		kubernetes1175Node("k8s1175-ext-blackbox-etcd", "Blackbox · etcd", "release-blackbox-exporter-source-6909da3-etcd", 2640, 300),
		kubernetes1175Node("k8s1175-ext-blackbox-master", "Blackbox · Control", "release-blackbox-exporter-source-6909da3", 2640, 400),
		kubernetes1175Node("k8s1175-ext-blackbox-worker", "Blackbox · Worker", "release-blackbox-exporter-source-6909da3-worker", 2640, 500),
		kubernetes1175Node("k8s1175-ext-node-exporter-master", "Node Exporter · Control", "release-node-exporter-0.18.0", 2900, 0),
		kubernetes1175Node("k8s1175-ext-node-exporter-worker", "Node Exporter · Worker", "release-node-exporter-0.18.0-worker", 2900, 100),
		kubernetes1175Node("k8s1175-ext-metrics", "Metrics Server", "release-metrics-server-0.3.1", 2900, 200),
		kubernetes1175Node("k8s1175-ext-amc-master", "AMC · Control", "release-amc-source-6909da3", 2900, 300),
		kubernetes1175Node("k8s1175-ext-amc-worker", "AMC · Worker", "release-amc-source-6909da3-worker", 2900, 400),
		kubernetes1175Node("k8s1175-ext-gluster-master", "GlusterFS · Control", "release-glusterfs-client-3.12.6", 2900, 500),
		kubernetes1175Node("k8s1175-ext-gluster-worker", "GlusterFS · Worker", "release-glusterfs-client-3.12.6-worker", 2900, 600),
		kubernetes1175Node("k8s1175-ext-pprof-etcd", "Go/pprof · etcd", "release-go-pprof-toolkit-source-6909da3-etcd", 3160, 0),
		kubernetes1175Node("k8s1175-ext-pprof-master", "Go/pprof · Control", "release-go-pprof-toolkit-source-6909da3", 3160, 100),
		kubernetes1175Node("k8s1175-ext-pprof-worker", "Go/pprof · Worker", "release-go-pprof-toolkit-source-6909da3-worker", 3160, 200),
		kubernetes1175Node("k8s1175-ext-prometheus-access", "Prometheus Access", "release-prometheus-access-bootstrap-k8s-1.17.5", 3160, 300),
		kubernetes1175Node("k8s1175-ext-autoscaling-rbac", "Autoscaling RBAC", "release-autoscaling-rbac-k8s-1.17.5", 3160, 400),
	}
...
func (s Seeder) seedKubernetes1175Environment(ctx context.Context, now time.Time) error {
	...
	revision := domain.EnvironmentRevision{ID: "environment-k8s-1.17.5-template-r1", EnvironmentID: environment.ID, Revision: 1, Facts: map[string]any{"architecture": "amd64", "operatingSystem": "SUSE", "ipFamily": "IPv4"}, Inventory: inventory, Variables: map[string]string{"FILE_STATION": "192.0.2.80:8080"}, CredentialRefs: []domain.CredentialRef{{Name: "K8S_ENCRYPTION_KEY", Kind: "envVarRef", Reference: "NEWPLATFORM_K8S1175_ENCRYPTION_KEY", Configured: true}}, CreatedBy: EnvironmentOwnerID, ChangeReason: "初始化首版测试环境模板", CreatedAt: now}
