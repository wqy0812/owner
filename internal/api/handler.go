...
func (h *Handler) routes() {
	...
	h.router.HandleFunc("GET /api/v1/environment-parameter-definitions", h.listEnvironmentParameterDefinitions)
	h.router.HandleFunc("POST /api/v1/environment-parameter-definitions", h.createEnvironmentParameterDefinition)
	h.router.HandleFunc("PUT /api/v1/environment-parameter-definitions/{id}/default", h.updateEnvironmentParameterDefault)
	h.router.HandleFunc("DELETE /api/v1/environment-parameter-definitions/{id}", h.deleteEnvironmentParameterDefinition)
