...
func (h *Handler) routes() {
	...
	h.router.HandleFunc("GET /api/v1/runs/{id}/verified-job-eligibility", h.verifiedJobEligibility)
	h.router.HandleFunc("GET /api/v1/executor-health", h.executorHealth)
	h.router.HandleFunc("POST /api/v1/execution-preparations", h.createPreparation)
	h.router.HandleFunc("GET /api/v1/execution-preparations", h.listPreparations)
	h.router.HandleFunc("GET /api/v1/execution-preparations/{id}", h.getPreparation)
	h.router.HandleFunc("POST /api/v1/execution-preparations/{id}/cancel", h.cancelPreparation)
	h.router.HandleFunc("GET /api/v1/events", h.events)
	h.router.HandleFunc("GET /api/v1/workbench", h.workbench)
	h.router.HandleFunc("GET /api/v1/approvals/batch-candidates", h.batchApprovalCandidates)
	h.router.HandleFunc("GET /api/v1/platform-option-categories", h.listPlatformOptionCategories)
	h.router.HandleFunc("POST /api/v1/platform-option-categories", h.createPlatformOptionCategory)
	h.router.HandleFunc("PATCH /api/v1/platform-option-categories/{id}", h.renamePlatformOptionCategory)
	h.router.HandleFunc("DELETE /api/v1/platform-option-categories/{id}", h.deletePlatformOptionCategory)
	h.router.HandleFunc("POST /api/v1/platform-option-categories/{id}/options", h.createPlatformOption)
	h.router.HandleFunc("PATCH /api/v1/platform-options/{id}", h.renamePlatformOption)
	h.router.HandleFunc("DELETE /api/v1/platform-options/{id}", h.deletePlatformOption)
	h.router.HandleFunc("GET /api/v1/environment-variable-definitions", h.listEnvironmentVariableDefinitions)
	h.router.HandleFunc("POST /api/v1/environment-variable-definitions", h.createEnvironmentVariableDefinition)
	h.router.HandleFunc("DELETE /api/v1/environment-variable-definitions/{id}", h.deleteEnvironmentVariableDefinition)
	...
	h.router.HandleFunc("GET /api/v1/components/{id}/usage", h.componentUsage)
	...
	h.router.HandleFunc("DELETE /api/v1/components/{id}", h.deleteComponent)
	...
	h.router.HandleFunc("PATCH /api/v1/component-releases/{id}/contract", h.patchReleaseContract)
	...
	h.router.HandleFunc("DELETE /api/v1/component-releases/{id}/playbook", h.deleteReleasePlaybook)
	h.router.HandleFunc("GET /api/v1/component-releases/{id}/playbook-workspace", h.listReleasePlaybookWorkspace)
	h.router.HandleFunc("GET /api/v1/component-releases/{id}/playbook-workspace/file", h.getReleasePlaybookWorkspaceFile)
	h.router.HandleFunc("PUT /api/v1/component-releases/{id}/playbook-workspace/file", h.saveReleasePlaybookWorkspaceFile)
	h.router.HandleFunc("POST /api/v1/component-releases/{id}/playbook-workspace/file", h.uploadReleasePlaybookWorkspaceFile)
	h.router.HandleFunc("PATCH /api/v1/component-releases/{id}/playbook-workspace/file", h.renameReleasePlaybookWorkspaceFile)
	h.router.HandleFunc("DELETE /api/v1/component-releases/{id}/playbook-workspace/file", h.deleteReleasePlaybookWorkspaceFile)
	h.router.HandleFunc("DELETE /api/v1/component-releases/{id}/playbook-workspace/directory", h.deleteReleasePlaybookWorkspaceDirectory)
	...
	h.router.HandleFunc("POST /api/v1/component-releases/{id}/review-submission", h.submitReleaseReview)
	h.router.HandleFunc("GET /api/v1/component-releases/{id}/review-preview", h.previewReleaseReview)
	h.router.HandleFunc("POST /api/v1/component-releases/{id}/review-decision", h.decideReleaseReview)
	...
	h.router.HandleFunc("POST /api/v1/scenarios/fork-plan", h.previewScenarioFork)
	h.router.HandleFunc("POST /api/v1/scenarios/forks", h.forkScenario)
	h.router.HandleFunc("POST /api/v1/scenario-revisions/{id}/edit", h.reopenScenarioRevision)
	h.router.HandleFunc("PUT /api/v1/scenario-revisions/{id}/upgrade-constraints", h.saveScenarioUpgradeConstraints)
	h.router.HandleFunc("POST /api/v1/scenario-revisions/{id}/execution-plan", h.previewScenarioExecution)
	h.router.HandleFunc("GET /api/v1/scenario-revisions/{id}/acceptance", h.readScenarioAcceptance)
	h.router.HandleFunc("PUT /api/v1/scenario-revisions/{id}/acceptance", h.saveScenarioAcceptance)
	h.router.HandleFunc("GET /api/v1/scenario-revisions/{id}/acceptance/workspace", h.listScenarioAcceptanceWorkspace)
	h.router.HandleFunc("GET /api/v1/scenario-revisions/{id}/acceptance/workspace/file", h.readScenarioAcceptanceFile)
	h.router.HandleFunc("PUT /api/v1/scenario-revisions/{id}/acceptance/workspace/file", h.saveScenarioAcceptanceFile)
	h.router.HandleFunc("DELETE /api/v1/scenario-revisions/{id}/acceptance/workspace/file", h.deleteScenarioAcceptanceFile)
	h.router.HandleFunc("POST /api/v1/scenario-revisions/{id}/acceptance/workspace/upload", h.uploadScenarioAcceptanceFile)
	...
	h.router.HandleFunc("GET /api/v1/scenario-revisions/{id}/parameter-overview", h.scenarioParameterOverview)
	h.router.HandleFunc("GET /api/v1/scenario-revisions/{id}/candidate-release-set", h.candidateReleaseSet)
	h.router.HandleFunc("POST /api/v1/scenario-revisions/{id}/test-runs", h.startScenarioLifecycleTest)
	h.router.HandleFunc("POST /api/v1/scenario-revisions/{id}/runs", h.startScenarioLifecycleRun)
	...
	h.router.HandleFunc("GET /api/v1/environment-parameter-fields", h.listEnvironmentParameterFields)
	h.router.HandleFunc("GET /api/v1/environments/{id}/credential-sources", h.environmentCredentialSources)
	h.router.HandleFunc("PUT /api/v1/environments/{id}/parameters", h.updateEnvironmentParameters)
	...
	h.router.HandleFunc("POST /api/v1/runs/archive", h.archiveRuns)
	h.router.HandleFunc("POST /api/v1/runs/cleanup-preview", h.previewRunCleanup)
	h.router.HandleFunc("POST /api/v1/runs/cleanup", h.cleanupRuns)
	h.router.HandleFunc("GET /api/v1/runs/{id}/archive-download", h.downloadRunArchive)
	h.router.HandleFunc("GET /api/v1/run-retention", h.runArchiveHealth)
	h.router.HandleFunc("PUT /api/v1/run-retention", h.saveRunRetention)
	h.router.HandleFunc("GET /api/v1/runs", h.listRuns)
	h.router.HandleFunc("GET /api/v1/runs/{id}", h.getRun)
	h.router.HandleFunc("GET /api/v1/runs/{id}/diagnostics", h.runDiagnostics)
	h.router.HandleFunc("GET /api/v1/runs/{id}/activity", h.runActivity)
	h.router.HandleFunc("GET /api/v1/runs/{id}/log-bundle", h.downloadRunLogs)
	h.router.HandleFunc("GET /api/v1/runs/{id}/job-bundle", h.downloadRunJob)
	h.router.HandleFunc("POST /api/v1/scenario-revisions/{id}/job-plan", h.previewScenarioJob)
	h.router.HandleFunc("POST /api/v1/scenario-revisions/{id}/job-bundle", h.exportScenarioJob)
